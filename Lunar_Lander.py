...
tf.disable_v2_behavior()  # TF1 seems to run faster
    ...
    def learn_double_q(self):
        ...
        for experience in minibatch:
            ...
            if done:
                ...
                policy_net_selected_action = np.argmax(self.policy_net.predict(next_state))

                target_net_evaluated_q_value = self.target_net.predict(next_state)[0][policy_net_selected_action]
